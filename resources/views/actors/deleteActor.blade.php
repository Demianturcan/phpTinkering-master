...
<section class="flex flex-col min-h-screen bg-gray-100 p-6">
    <div class="flex-grow">
        <div class="max-w-md mx-auto bg-white shadow-md rounded-lg p-6">
            <h1 class="text-2xl font-bold mb-4">Delete Actor</h1>
            <p class="mb-4">Are you sure you want to delete the actor "<strong><?= htmlspecialchars($actor->name) ?></strong>"?</p>

            <form action="/destroyActor" method="POST" class="mt-4">
            ...
            <a href="/actors" class="text-gray-500 hover:underline mt-4 block">Cancel</a>
        </div>
    </div>
</section>
